...
def main():
    """Main training pipeline for 1-HOUR FORECASTING."""
    print("\n" + "="*70)
    print("AZURE VM IDLE/ACTIVE FORECASTING - 1 HOUR AHEAD")
    ...
    results_dir = 'results_azure_forecast_1hr'
    ...
    print("\n" + "="*70)
    print("FORECASTING MODE: Predicting 1 HOUR into the future")
    print("  Input:  Past 60 minutes [t-60 to t-0]")
    print("  Output: Future state at t+60 (IDLE/ACTIVE)")
    print("  Question: 'WILL the VM be idle or active 1 HOUR FROM NOW?'")
    print("="*70)
    X, y, vm_ids = create_sequences(df, lookback=LOOKBACK, prediction_horizon=PREDICTION_HORIZON)
    ...
    results = {
        ...
        'task': 'forecasting',
        'prediction_type': '1_hour_ahead_classification',
        ...
        'forecast_time': f'{PREDICTION_HORIZON * 5} minutes',
